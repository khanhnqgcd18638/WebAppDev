...
namespace AppDeve.Controllers
{
    public class StaffController : Controller
    {
        ...
        {
            var create_category = new Category() { Name = category.Name };
        ...
        {
            var courseCategory = new CategoryCourseModel()
            {
        ...
        [HttpPost]
        public ActionResult CreateCourse(CategoryCourseModel categoryCourseModel)
        {
            var new_course = new Course()
            {
                Name = categoryCourseModel.Course.Name,
                Category_Id = categoryCourseModel.CategoryId
            };
